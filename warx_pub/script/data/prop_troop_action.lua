...
prop_troop_action = {
	...
	[Spy] = { TroopAction = Spy, SpeedMarch = 0, SpeedMarchPvE = 0, SpeedRally = 0, SpeedCavaran = 0, Default = 100, IsPvp = 2,},
	...
	[SiegeNpc] = { TroopAction = SiegeNpc, SpeedMarch = 1, SpeedMarchPvE = 1, SpeedRally = 0, SpeedCavaran = 0, Default = nil, IsPvp = 0,},
	...
	[HoldDefenseNPC] = { TroopAction = HoldDefenseNPC, SpeedMarch = 1, SpeedMarchPvE = 1, SpeedRally = 0, SpeedCavaran = 0, Default = nil, IsPvp = 0,},
