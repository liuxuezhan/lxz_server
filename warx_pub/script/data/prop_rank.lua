...
prop_rank = {
	...
	[RANK_15] = { ID = RANK_15, Name = LG_RANK_NAME_165100014, Class = 3, ListA = LG_RANK_LISTA_165200014, ListB = LG_RANK_LISTB_165300014, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_16] = { ID = RANK_16, Name = LG_RANK_NAME_165100015, Class = 3, ListA = LG_RANK_LISTA_165200015, ListB = LG_RANK_LISTB_165300015, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_17] = { ID = RANK_17, Name = LG_RANK_NAME_165100016, Class = 3, ListA = LG_RANK_LISTA_165200016, ListB = LG_RANK_LISTB_165300016, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_18] = { ID = RANK_18, Name = LG_RANK_NAME_165100017, Class = 3, ListA = LG_RANK_LISTA_165200017, ListB = LG_RANK_LISTB_165300017, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_19] = { ID = RANK_19, Name = LG_RANK_NAME_165100018, Class = 3, ListA = LG_RANK_LISTA_165200018, ListB = LG_RANK_LISTB_165300018, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_20] = { ID = RANK_20, Name = LG_RANK_NAME_165100019, Class = 3, ListA = LG_RANK_LISTA_165200019, ListB = LG_RANK_LISTB_165300019, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_21] = { ID = RANK_21, Name = LG_RANK_NAME_165100020, Class = 3, ListA = LG_RANK_LISTA_165200020, ListB = LG_RANK_LISTB_165300020, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_22] = { ID = RANK_22, Name = LG_RANK_NAME_165100021, Class = 3, ListA = LG_RANK_LISTA_165200021, ListB = LG_RANK_LISTB_165300021, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
	[RANK_23] = { ID = RANK_23, Name = LG_RANK_NAME_165100022, Class = 3, ListA = LG_RANK_LISTA_165200022, ListB = LG_RANK_LISTB_165300022, Num = 150, Limit = 9999999, IsPerson = 1, Keys = {"score"}, Skeys = {-1},},
}
