...
function mod.action(_idx)
    ...
    for i = 1, num do
        ...
        chat(def[i], "@adddaoju=7001001=100")
        chat(def[i], "@adddaoju=7001002=100")
        chat(def[i], "@adddaoju=7001003=100")
        
        chat(def[i], "@adddaoju=7002001=100")
        chat(def[i], "@adddaoju=7002002=100")
        chat(def[i], "@adddaoju=7002003=100")
        
        chat(def[i], "@adddaoju=7003001=100")
        chat(def[i], "@adddaoju=7003002=100")
        chat(def[i], "@adddaoju=7003003=100")
        
        chat(def[i], "@adddaoju=7004001=100")
        chat(def[i], "@adddaoju=7004002=100")
        chat(def[i], "@adddaoju=7004003=100")
