...
do_load(BasePath .. "define_mall_group_cross")
...
do_load(BasePath .. "define_cross_group")
do_load(BasePath .. "define_cross_act_notify")
do_load(BasePath .. "define_cross_act_stage")
do_load(BasePath .. "define_cross_royalty")
do_load(BasePath .. "define_cross_reward")
...
do_load(BasePath .. "define_operate_activity")
do_load(BasePath .. "define_operate_action")
do_load(BasePath .. "define_operate_award_exchange")
...
do_load(BasePath .. "define_cross_server_rank_award")
...
do_load(BasePath .. "define_city_event")
do_load(BasePath .. "define_tw_open")
do_load(BasePath .. "define_mc_open")
do_load(BasePath .. "define_hero_event_number")
do_load(BasePath .. "define_hero_task_award")
do_load(BasePath .. "define_hero_equip")
do_load(BasePath .. "define_facebook_login_award")
do_load(BasePath .. "define_daily_activity")
do_load(BasePath .. "define_daily_activity_award")
do_load(BasePath .. "define_daily_activity_group")
do_load(BasePath .. "define_daily_activity_score")

do_load(BasePath .. "prop_buy_group")
do_load(BasePath .. "prop_buy")
do_load(BasePath .. "prop_cross_group")
do_load(BasePath .. "prop_cross_act_notify")
do_load(BasePath .. "prop_cross_act_stage")
do_load(BasePath .. "prop_cross_royalty")
do_load(BasePath .. "prop_cross_reward")
...
do_load(BasePath .. "prop_mall_group_cross")
...
do_load(BasePath .. "prop_buy_month_card_group")
...
do_load(BasePath .. "prop_tribute_exchange")
do_load(BasePath .. "prop_operate_activity")
do_load(BasePath .. "prop_operate_action")
do_load(BasePath .. "prop_operate_award_exchange")
...
do_load(BasePath .. "prop_cross_server_rank_award")
...
do_load(BasePath .. "prop_city_event")
do_load(BasePath .. "prop_tw_open")
do_load(BasePath .. "prop_mc_open")
do_load(BasePath .. "prop_hero_event_number")
do_load(BasePath .. "prop_hero_task_award")
do_load(BasePath .. "prop_hero_equip")
do_load(BasePath .. "prop_facebook_login_award")
do_load(BasePath .. "prop_daily_activity")
do_load(BasePath .. "prop_daily_activity_award")
do_load(BasePath .. "prop_daily_activity_group")
do_load(BasePath .. "prop_daily_activity_score")
