package.cpath = "luaclib/?.so;lxzserver/lib/?.so"
dofile("lxzserver/lib/src/base.lua")
...
--[[
local fd = assert(socket.connect("127.0.0.1", 80010))
...
print("data is ", encode_token(token))
local etoken = crypt.desencode(secret, encode_token(token))
local b = crypt.base64encode(etoken)
print("data22 is ", encode_token(token))
