...
function leave_union(ply)
	...
	clear_donate_data(ply,resmng.DONATE_RANKING_TYPE.DAY_B)
    clear_donate_data(ply,resmng.DONATE_RANKING_TYPE.WEEK_B)
    clear_donate_data(ply,resmng.DONATE_RANKING_TYPE.UNION_B)
    gPendingSave.union_member[ply.pid] = ply._union
end
