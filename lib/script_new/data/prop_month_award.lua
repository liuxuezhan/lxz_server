...
prop_month_award = {
	...
	[MONTH_AWARD_7] = { ID = MONTH_AWARD_7, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"item",4002019,1,10000}}, Extra = {3,2},},
	...
	[MONTH_AWARD_11] = { ID = MONTH_AWARD_11, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"item",2011002,2,10000}}, Extra = {5,2},},
	...
	[MONTH_AWARD_14] = { ID = MONTH_AWARD_14, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"item",4002019,2,10000}}, Extra = {6,2},},
	...
	[MONTH_AWARD_18] = { ID = MONTH_AWARD_18, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"item",1002006,1,10000}}, Extra = {8,2},},
	...
	[MONTH_AWARD_21] = { ID = MONTH_AWARD_21, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"item",4002019,3,10000}}, Extra = {9,2},},
	[MONTH_AWARD_22] = { ID = MONTH_AWARD_22, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"res",8,125000,10000}}, Extra = {10,2},},
	...
	[MONTH_AWARD_28] = { ID = MONTH_AWARD_28, Month = 1, BonusPolicy = "mutex_award", Bonus = {{"hero",19,1,10000}}, Extra = {11,2},},
	...
	[MONTH_AWARD_31] = { ID = MONTH_AWARD_31, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",1002005,1,10000}}, Extra = {2,2},},
	[MONTH_AWARD_32] = { ID = MONTH_AWARD_32, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",8004001,1,10000}}, Extra = nil,},
	[MONTH_AWARD_33] = { ID = MONTH_AWARD_33, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",2011002,1,10000}}, Extra = {3,2},},
	...
	[MONTH_AWARD_38] = { ID = MONTH_AWARD_38, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",1001005,1,10000}}, Extra = {5,2},},
	[MONTH_AWARD_39] = { ID = MONTH_AWARD_39, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",8003001,1,10000}}, Extra = nil,},
	[MONTH_AWARD_40] = { ID = MONTH_AWARD_40, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",2011002,1,10000}}, Extra = {6,2},},
	...
	[MONTH_AWARD_47] = { ID = MONTH_AWARD_47, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",2011002,2,10000}}, Extra = {8,2},},
	[MONTH_AWARD_48] = { ID = MONTH_AWARD_48, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",3004002,2,10000}}, Extra = nil,},
	[MONTH_AWARD_49] = { ID = MONTH_AWARD_49, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",4002011,10,10000}}, Extra = {9,2},},
	...
	[MONTH_AWARD_56] = { ID = MONTH_AWARD_56, Month = 2, BonusPolicy = "mutex_award", Bonus = {{"item",4002019,10,10000}}, Extra = {11,2},},
}
