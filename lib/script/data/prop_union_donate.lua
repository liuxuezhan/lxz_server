...
prop_union_donate = {
	...
	[UNION_TECH_CLASS_2] = { ID = UNION_TECH_CLASS_2, Primary = {{1,5000,33},{2,5000,34},{3,1000,33}}, Medium = {6,10}, Senior = {6,20}, Pincome = {200,200,100}, Mincome = {1000,1000,500}, Sincome = {5000,5000,2500}, TmAdd = 720,},
